...
urlpatterns = [
    ...
    path('users/requests/', FriendRequestAPIView.as_view(), name='friend-create'),
    path('users/requests/<int:pk>',FriendRequestDetailAPIView.as_view(), name='friendrequest-detail'),
]